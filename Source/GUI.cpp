...
GUI::GUI ()
{
    ...
    addAndMakeVisible (timenum = new Label ("timenum",
                                            TRANS("0")));
    ...
    addAndMakeVisible (scorenum = new Label ("scorenum",
                                             TRANS("0")));
    ...
    addAndMakeVisible (highnum = new Label ("highnum",
                                            TRANS("0")));
...
void GUI::resized()
{
    ...
    textButton->setBounds (proportionOfWidth (0.5000f) - (proportionOfWidth (0.3004f) / 2), proportionOfHeight (0.0941f), proportionOfWidth (0.3004f), proportionOfHeight (0.0807f));
...
<JUCER_COMPONENT documentType="Component" className="GUI" componentName="" parentClasses="public Component"
  ...
  <TEXTBUTTON name="new button" id="20981b42f581d91a" memberName="textButton"
              virtualName="" explicitFocusOrder="0" pos="50%c 9.494% 29.904% 8.017%"
  ...
  <TEXTBUTTON name="new button" id="e4b5af20fb96c98" memberName="textButton2"
              virtualName="" explicitFocusOrder="0" pos="74.116%c 81.013%c 29.904% 6.751%"
  ...
  <LABEL name="timenum" id="e6cc714430292fb2" memberName="timenum" virtualName=""
         explicitFocusOrder="0" pos="59.164% 27.004% 72 24" edTextCol="ff000000"
  ...
  <LABEL name="scorenum" id="ea0d6984061c4288" memberName="scorenum" virtualName=""
         explicitFocusOrder="0" pos="59.164% 35.443% 72 24" edTextCol="ff000000"
         edBkgCol="0" labelText="0" editableSingleClick="0" editableDoubleClick="0"
         focusDiscardsChanges="0" fontname="Default font" fontsize="20"
         kerning="0" bold="0" italic="0" justification="33"/>
  <LABEL name="highnum" id="75ba19dea2e0aced" memberName="highnum" virtualName=""
         explicitFocusOrder="0" pos="59.164% 43.882% 72 24" edTextCol="ff000000"
         edBkgCol="0" labelText="0" editableSingleClick="0" editableDoubleClick="0"
         focusDiscardsChanges="0" fontname="Default font" fontsize="20"
         kerning="0" bold="0" italic="0" justification="33"/>
  <SLIDER name="new slider" id="d91aea79d68904bd" memberName="slider" virtualName=""
          explicitFocusOrder="0" pos="5.145% 86.287%r 70 25.527%" min="512"
          max="2048" int="1" style="LinearVertical" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <SLIDER name="new slider" id="f1bc1b479f2d8ae3" memberName="slider2"
          virtualName="" explicitFocusOrder="0" pos="28.296% 86.287%r 70 25.527%"
          min="1" max="60" int="1" style="LinearVertical" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <TEXTBUTTON name="new button" id="304faab1a0cf478d" memberName="textButton3"
              virtualName="" explicitFocusOrder="0" pos="59.164% 64.135% 29.904% 6.751%"
